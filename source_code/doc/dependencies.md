...
These are the dependencies currently used by MYGCoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/mygcoinnl
Keybase  - https://keybase.io/team/mygcoin/
