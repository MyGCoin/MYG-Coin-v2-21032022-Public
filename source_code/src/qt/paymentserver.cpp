...
const QString BITCOIN_IPC_PREFIX("mygcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/mygcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/mygcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/mygcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click mygcoin: links
...
//
// OSX-specific way of handling mygcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in mygcoin: URIs
