...
#if defined(NDEBUG)
# error "MYGCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "MYGCoin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // MYGCoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // MYGCoin also requires low S in sigs
